...
export interface ScriptConfluxRow{
   ...
   *
  * @param key  값을 반환 받을 데이터 컬럼명 파라미터
  */
   ...
   *
  * @param key   값을 반환 받을 실수형 데이터 컬럼명 파라미터
  */
   ...
   *
  * @param key   값을 반환 받을 정수형 데이터 컬럼명 파라미터
  */
   ...
   *
  * @param key 값을 반환 받을 문자형데이터 컬럼명 파라미터
  */
   ...
   *
  * @param key 데이터 타입을 반환 받을 컬럼명 파라미터
  */
  ...
  */
   ...
   *
  * @param key 데이터를 설정할 컬럼명을 지정하는 파라미터
  * @param value 데이터 값을 지정하는 파라미터
  */
