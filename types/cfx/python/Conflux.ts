...
export interface Conflux{
  ...
  */
   ...
   *
  * @param name
  * 결과 데이터의 이름을 지정하는 파라미터
  * 
  * @param result_table
  *  결과 데이터로 넘길 ResultTable 객체를 지정하는 파라미터
  * 
  */
  ...
  * 
  * @param result_table
  * 결과 데이터로 넘길 Pandas Dataframe 객체를 지정하는 파라미터
  * 
  */
  ...
  */
   ...
   * ```
  * @param key
  * Conflux의 Context 정보를 가져오는데 사용되는 key값 파라미터
  * 
  */
   ...
   *
  * @param name
  * 데이터를 Pandas Dataframe으로 변환하여 가져올 노드의 코드, 테이블명, 이름을 입력받는 파라미터
  * 
  */
   ...
   *
  * @param name
  * 데이터로 가져올 노드의 코드, 테이블명, 이름을 입력받는 파라미터
  * 
  */
  ...
  */
   ...
   *
  * @param key
  *  저장할 변수의 key값을 지정하는 파라미터
  * 
  * @param value
  *  저장할 변수의 값을 지정하는 파라미터
  * 
  */
