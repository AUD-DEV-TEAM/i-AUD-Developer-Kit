...
/**
* Scatter 유형의 차트를 표현할 수 있는 차트 컨트롤입니다.
*/
export interface ScatterChart extends Control{
  ...
  */
  ...
  /**
   * Scatter 차트의 영역과 기본 옵션 정보를 가져옵니다.
  */
  ...
  */
  ...
  /**
   * Scatter 차트에 바인딩된 계열의 객체 정보를 가져옵니다.
  */
  ExtraSeriesInfo: ExtraSeriesInfoCollection;

  /**
   * Scatter 차트의 데이터셋 필드 정보를 가져옵니다.
  */
  ...
  */
  ...
  /**
   * 계열별 차트 종류에 대한 구성 옵션 정보를 가져옵니다.
  */
  PlotOptions: PlotOptions;

  /**
   * Scatter 차트의 제목 옵션 정보를 가져옵니다.
  */
  Title: Title;
  ...
  */
  ...
  /**
   * Scatter 차트에 바인딩된 데이터소스 이름을 반환합니다.
   *
  */
  ...
  */
   ...
   *
   * @param sender 이벤트가 발생한 Scatter 차트 컨트롤
   * @param args 이벤트 인자
   *
   * Target : {@link ScatterChart}
  */
