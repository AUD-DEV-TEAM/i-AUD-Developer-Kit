...
// 컨트롤 변수 선언
let tbxReportName: Label;
let imgchart: Image;
let imgMeta: Image;
let TableLayout: TableLayout;
let GRP_CONDITION: Group;
let rdoXlsx: RadioButton;
let Label2: Label;
let rdoHTML: RadioButton;
let rdoWord: RadioButton;
let rdoCSV: RadioButton;
let rdoText: RadioButton;
let rdoHWP: RadioButton;
let grpSeperate: Group;
let Label4: Label;
let Label5: Label;
let ColumnSeperator: TextBox;
let Label6: Label;
let RowSeperator: TextBox;
 ...
 * * arguments :
 *****************************************/
const OnDocumentLoadComplete = function (_sender: any, _args: any) {
  Matrix.Alert("22");
  ...
  ColumnSeperator.Text = (
    parent as any
  ).iStudioConfig.DataGridTextExportColSeparator;
  RowSeperator.Text = (
    parent as any
  ).iStudioConfig.DataGridTextExportRowSeparator;
};
 ...
 *****************************************/
const OnLoadComplete = function (_sender: any, _args: any) {
  try {
...
const OnNewReportWizardChanged = function (_sender: any, args: any) {
  Matrix.TemplateLoadedSetting(DataGrid!.Name);
  makeMetaFilters(true);
  args.Handled = true;
};

const makeMetaFilters = function (isLoading: boolean) {
  const option = {
    UseGroup: false,
...
const Execute = function (isLoading: boolean) {
 ...
 *****************************************/
const OnExecuteStart = function (_sender: any, args: any) {
 ...
 *****************************************/
const OnMetaLayoutChange = function (_sender: any, args: any) {
  args.Handled = true;
  Execute(false);
};
 ...
 *****************************************/
const OnImageClick = function (_sender: any, args: any) {
  if (args.Id == "imgMeta") {
 ...
 * * arguments :
 *****************************************/
const OnExcelExportStart = function (_sender: any, _args: any) {
  ...
  WIN_EXPORT.OnDialogResult = function (type: string) {
    if (type == "OK") {
      ...
      //else if(rdoText.Checked) Matrix.ExportServiceCall("DataGrid" ,1);//text
        ...
        // 구분자 세팅
        (parent as any).iStudioConfig.DataGridTextExportColSeparator =
          ColumnSeperator.Text;
        (parent as any).iStudioConfig.DataGridTextExportRowSeparator =
          RowSeperator.Text;
  ...
  WIN_EXPORT.OnClosed = function (_s: any, _e: any) {
    WIN_EXPORT = null;
  };
  WIN_EXPORT.MoveToCenter();
};

const exportFile = function (type: string) {
  ...
  // excel column name
  const getColumnName = function (num: number) {
    let ret = "";
 ...
 *****************************************/
const OnRadioValueChange = function (_sender: any, args: any) {
